...
::::
:::: {.column width="30%"}
**Slides and presentations on DataLad** by Dr. Adina Wagner, e.g., "DataLad - Decentralized Management of Digital Objects for Open Science" [@wagner2024] and [on YouTube](https://www.youtube.com/c/DataLad)
::::
:::: {.column width="15%"}
![[DataLad Handbook](https://handbook.datalad.org/en/latest/) by @wagner2022 ([CC BY-SA 4.0](https://handbook.datalad.org/en/latest/licenses.html))](images/datalad-handbook-logo.svg){width=100% fig-align="center"}
::::
:::: {.column width="25%"}
...
::: {.column width="50%"}
::: {.fragment}
![[git-scm.com](https://git-scm.com/) (Logo by Jason Long; License: [CC BY 3.0 Unported](https://git-scm.com/downloads/logos))](images/git-logo-full.svg){fig-align="center" width="40%"}
...
::: {.column width="50%"}
::: {.fragment}
![[datalad.org](https://www.datalad.org/)](images/datalad-logo-full.svg){fig-align="center" width="38%"}
...
![from the [Datalad Handbook](https://handbook.datalad.org/en/latest/index.html#) (License: [CC BY-SA 4.0](https://handbook.datalad.org/en/latest/licenses.html))](images/datalad-publishing-gitvsannex.svg){fig-align="center" width="70%"}
...
![from the [Datalad Handbook](https://handbook.datalad.org/en/latest/intro/executive_summary.html) (License: [CC BY-SA 4.0](https://handbook.datalad.org/en/latest/licenses.html))](images/datalad-submodule-setup.svg){fig-align="center" width="100%"}
:::
::: {.fragment}
...
::: {.fragment}
### Research as a cycle
![@theturingwaycommunity2024 ([CC BY 4.0](https://doi.org/10.5281/zenodo.3332807))](images/turing-way-research-cycle.svg){fig-align="center" width="100%"}
:::
::: {.fragment}
...
## Nesting of modular DataLad datsets

![from the [Datalad Handbook](https://handbook.datalad.org/en/latest/basics/101-106-nesting.html) (License: [CC BY-SA 4.0](https://handbook.datalad.org/en/latest/licenses.html))](images/datalad-linkage-subds.svg){fig-align="center" width="90%"}
...
::: {.column width="45%"}
::: {.fragment fragment-index=2}
![[by Scriberia for The Turing Way community (CC BY 4.0)](https://zenodo.org/record/3695300/)](images/turing-way-provenance.svg){fig-align="center" width="80%"}
:::
:::
::::
...
::::: {.columns}
:::: {.column width="35%"}
![[by Scriberia for The Turing Way community (CC BY 4.0)](https://zenodo.org/record/3695300/)](images/turing-way-version-control.svg){fig-align="center" width="100%"}
::::
:::: {.column width="15%"}
"*Your number one collaborator is yourself from 6 months ago and they don't answer emails.*"
::::
:::: {.column width="35%"}
![](images/turing-way-readable-code.svg){fig-align="center" width="100%"}
::::
:::: {.column width="15%"}
...
::: {.fragment fragment-index=1}
![](images/datalad-run-basic.svg){fig-align="center" width="100%"}
:::
...
![Access the dataset [on GitLab](https://git.mpib-berlin.mpg.de/wittkuhn/neuro-data)](images/gitlab-screenshot.png){fig-align="center" width="100%"}

:::
::::
:::::

## Share and develop ~~data~~ *anything* like source code
...
install(ok): /tmp/neuro-data-clone (dataset)
```
...
get(ok): dataset_description.json (file) [from gin-src...]
[...]
```
