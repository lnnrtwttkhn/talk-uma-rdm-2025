...
![](images/datalad-publishing-network.svg){fig-align="center" width="100%"}
...
![](images/datalad-services-connected.png){fig-align="center" width="50%"}
...
![[keeper.mpdl.mpg.de](https://keeper.mpdl.mpg.de/)](images/keeper-logo.svg){fig-align="center" width="20%"}
...
#### DataLad - Dataverse integration (details [here]())
...
## Data sharing via ownCloud / Nextcloud
...
#### :sparkles: Advantages of ownCloud and Nextcloud :sparkles:
...
```{bash}
User name and password are required for WebDAV access at https://owncloud.gwdg.de/remote.php/nonshib-webdav/neuro-data
user: wittkuhn@mpib-berlin.mpg.de
password: supersafepassword
```

3. Push dataset to ownCloud

```{bash}
datalad push --to owncloud-gwdg
```

![Access the dataset [on owncloud.gwdg.de](https://owncloud.gwdg.de/index.php/s/VcH0w7sGIcYonld)](images/owncloud-screenshot.png){fig-align="center" width="80%"}
...
#### :sparkles: Advantages of GIN :sparkles:
...
- servers are on German land (Munich, Germany; cf. GDPR)
...
3. Clone dataset from GIN

```{bash}
datalad clone https://gin.g-node.org/lnnrtwttkhn/neuro-data.git
```
