...
::: {.column width="50%"}
::: {.fragment}
![from the [DataLad Handbook](https://handbook.datalad.org/en/latest/index.html) by @wagner2022 ([CC BY-SA 4.0](https://handbook.datalad.org/en/latest/licenses.html))](images/datalad-local_wf.svg){fig-align="center" width=100%}
...
::::: {.columns}
:::: {.column width="35%"}
![by @theturingwaycommunity2024](images/turing-way-version-control.svg){fig-align="center" width="100%"}
::::
:::: {.column width="15%"}
"*Your number one collaborator is yourself from 6 months ago and they don't answer emails.*"
::::
:::: {.column width="35%"}
![by @theturingwaycommunity2024 ([CC BY 4.0](https://creativecommons.org/licenses/by/4.0/))](images/turing-way-readable-code.svg){fig-align="center" width="100%"}
::::
:::: {.column width="15%"}
